...
def line_chart():  
    ...
    dataframe8["acierto del modelo"]=["","","","no","no","",""]	
    ...
    interpretaciones=["dummy",interpretacion1,interpretacion2,interpretacion3,interpretacion4,interpretacion5,interpretacion6,interpretacion7,interpretacion8]
...
def last_batch():   
    ...
    fechaFin=fecha[6]
    interpretacion={}
    interpretacion[0]="El modelo sugiere que la tasa de cambio podría ser negativa a partir 04-10-2018 excepto el 09-10-2018. Esto implicaría que:"
    ...
    interpretacion[4]="Si el precio de cierre del " + str(dataframeprevious["fecha"][3]) + " fue de " + str(dataframeprevious["precios"][3]) + ", el precio de cierre del " + str(dataframe["fecha"][3]) + " podría ser menor a " + str(dataframeprevious["precios"][3]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[10])
