...
def line_chart():  
    ...
    dataframe7["acierto del modelo"]=["","","","si","no","no",""]	
    ...
    interpretacion7[2]="Si el precio de cierre del " + str(dataframe7previous["fecha"][1]) + " fue de " + str(dataframe7previous["precios"][1]) + ", el precio de cierre del " + str(dataframe7["fecha"][0]) + " podria ser mayor a " + str(dataframe7previous["precios"][1]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[8])
    interpretacion7[3]="Si el precio de cierre del " + str(dataframe7previous["fecha"][2]) + " fue de " + str(dataframe7previous["precios"][2]) + ", el precio de cierre del " + str(dataframe7["fecha"][0]) + " podria ser mayor a " + str(dataframe7previous["precios"][2]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[9])
    interpretacion7[4]="Si el precio de cierre del " + str(dataframe7previous["fecha"][3]) + " fue de " + str(dataframe7previous["precios"][3]) + ", el precio de cierre del " + str(dataframe7["fecha"][0]) + " podria ser mayor a " + str(dataframe7previous["precios"][3]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[10])
    interpretacion7[5]="Si el precio de cierre del " + str(dataframe7previous["fecha"][4]) + " fue de " + str(dataframe7previous["precios"][4]) + ", el precio de cierre del " + str(dataframe7["fecha"][0]) + " podria ser mayor a " + str(dataframe7previous["precios"][4]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[11])
    interpretacion7[6]="Si el precio de cierre del " + str(dataframe7previous["fecha"][5]) + " fue de " + str(dataframe7previous["precios"][5]) + ", el precio de cierre del " + "24-09-2018" + " podria ser mayor a " + str(dataframe7previous["precios"][5]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[12])
    interpretacion7[7]="Si el precio de cierre del " + str(dataframe7previous["fecha"][6]) + " fue de " + str(dataframe7previous["precios"][6]) + ", el precio de cierre del " + "25-09-2018" + " podria ser mayor a " + str(dataframe7previous["precios"][6]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[13])      
...
def last_batch():   
    ...
    interpretacion[7]="Si el precio de cierre del " + str(dataframeprevious["fecha"][6]) + " fue de " + str(dataframeprevious["precios"][6]) + ", el precio de cierre del " + "02-11-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][6]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[13])      
