...
def line_chart():  
    ...
    interpretacion4[1]="Si el precio de cierre del " + str(dataframe4previous["fecha"][0]) + " fue de " + str(dataframe4previous["precios"][0]) + ", el precio de cierre del " + str(dataframe4["fecha"][0]) + " podria ser mayor a " + str(dataframe4previous["precios"][0]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[7])
    interpretacion4[2]="Si el precio de cierre del " + str(dataframe4previous["fecha"][1]) + " fue de " + str(dataframe4previous["precios"][1]) + ", el precio de cierre del " + str(dataframe4["fecha"][1]) + " podria ser mayor a " + str(dataframe4previous["precios"][1]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[8])
    interpretacion4[3]="Si el precio de cierre del " + str(dataframe4previous["fecha"][2]) + " fue de " + str(dataframe4previous["precios"][2]) + ", el precio de cierre del " + str(dataframe4["fecha"][2]) + " podria ser mayor a " + str(dataframe4previous["precios"][2]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[9])
    interpretacion4[4]="Si el precio de cierre del " + str(dataframe4previous["fecha"][3]) + " fue de " + str(dataframe4previous["precios"][3]) + ", el precio de cierre del " + str(dataframe4["fecha"][3]) + " podria ser mayor a " + str(dataframe4previous["precios"][3]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[10])
    interpretacion4[5]="Si el precio de cierre del " + str(dataframe4previous["fecha"][4]) + " fue de " + str(dataframe4previous["precios"][4]) + ", el precio de cierre del " + str(dataframe4["fecha"][4]) + " podria ser mayor a " + str(dataframe4previous["precios"][4]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[11])
...
def last_batch():   
    ...
    interpretacion[1]="Si el precio de cierre del " + str(dataframeprevious["fecha"][0]) + " fue de " + str(dataframeprevious["precios"][0]) + ", el precio de cierre del " + "17-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][0]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[7])
    interpretacion[2]="Si el precio de cierre del " + str(dataframeprevious["fecha"][1]) + " fue de " + str(dataframeprevious["precios"][1]) + ", el precio de cierre del " + "18-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][1]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[8])
    interpretacion[3]="Si el precio de cierre del " + str(dataframeprevious["fecha"][2]) + " fue de " + str(dataframeprevious["precios"][2]) + ", el precio de cierre del " + "19-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][2]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[9])
    interpretacion[4]="Si el precio de cierre del " + str(dataframeprevious["fecha"][3]) + " fue de " + str(dataframeprevious["precios"][3]) + ", el precio de cierre del " + "20-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][3]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[10])
    interpretacion[5]="Si el precio de cierre del " + str(dataframeprevious["fecha"][4]) + " fue de " + str(dataframeprevious["precios"][4]) + ", el precio de cierre del " + "21-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][4]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[11])
    interpretacion[6]="Si el precio de cierre del " + str(dataframeprevious["fecha"][5]) + " fue de " + str(dataframeprevious["precios"][5]) + ", el precio de cierre del " + "24-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][5]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[12])
    interpretacion[7]="Si el precio de cierre del " + str(dataframeprevious["fecha"][6]) + " fue de " + str(dataframeprevious["precios"][6]) + ", el precio de cierre del " + "25-09-2018" + " podria ser mayor a " + str(dataframeprevious["precios"][6]) +" con una tasa de cambio posiblemente cercana a " + str(prediccion[13])      
